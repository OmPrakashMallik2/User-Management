...
function User() {
    return (
        <div className='flex w-full'>
            <div className='flex flex-col items-center bg-white p-10 mr-3 rounded w-2/5'>
                ...
                <div className='mt-5'>
                    ...
                    <button className='font-semibold bg-white border-solid border-2 border-blue-500 px-5 py-2 rounded text-lg mx-3 text-blue-500'>Message</button>
                </div>
            </div>
            <div className='bg-white ml-3 rounded px-10 py-5 w-3/5'>
